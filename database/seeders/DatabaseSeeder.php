...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $descriptions = ['К вождению Вы приступаете уже на следующий день после заключения договора, то есть не ждёте месяц-полтора, а начинаете практиковаться на автодроме сразу, параллельно теоретическим занятиям!', 'К вождению Вы приступаете уже на следующий день после заключения договора, то есть не ждёте месяц-полтора, а начинаете практиковаться на автодроме сразу, параллельно теоретическим занятиям.'];
        $prices = ['21000', '37000'];
        $files = ['moto.jpg', 'avto.jpeg'];
        for($i = 0; $i < count($names); $i++){
